...
sql_stmt   :  create_table_stmt ';'    { execute_create_table($1); }
		   ...
		   |  BACKUP STRING_LITERAL ';' { execute_backup($2); }
		   |  RESTORE STRING_LITERAL ';' { execute_restore($2); }
		   ;
...
rename_table_stmt    : RENAME TABLE table_name TO table_name { 
                      rename_info_t *info = (rename_info_t*)malloc(sizeof(rename_info_t));
                      info->old_name = $3;
                      info->new_name = $5;
                      $$ = info;
                   };
